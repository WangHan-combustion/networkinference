                    ...
                    if reactionType(n)==1
                        ...
                        if any(n==intermediateProposedInfluentialReactions)
                            ...
                            if proposalType==1
                                   ...
                                   if n~=7 && n~=2 && n~=1 && n~=4 && n~=9 && n~=10 && n~=12
                                   %if n~=2
                ...
                for n=1:nReactions
                    ...
                    if any(intermediateProposedInfluentialReactions==n)
                        if reactionType(n)==1
                           ...
                           if n~=7 && n~=2 && n~=1 && n~=4 && n~=9 && n~=10 && n~=12 %&& n~=8 && n~=11 && n~=13      
                           %if n~=2
                            ...
                            y(n+sum(reactionType(1:n-1))+1)=d1(1+n+sum(reactionType(1:n-1)))+(priorRange(2,1+n+sum(reactionType(1:n-1)))-priorRange(1,1+n+sum(reactionType(1:n-1))))/20*randn(1);                                                                                                               
                                     ...
                                     elseif n==4
                                      ...
                                      y(1+n+sum(reactionType(1:n-1)))=2.0;                                          
                                     elseif n==8  
                                      y(n+sum(reactionType(1:n-1)))=0.4953;
                                      y(1+n+sum(reactionType(1:n-1)))=0.4953; 
                                     elseif n==9  
                                      y(n+sum(reactionType(1:n-1)))=1.0;
                                      y(1+n+sum(reactionType(1:n-1)))=1.0;                                       
                                     elseif n==10 
                                      ...
                                      y(1+n+sum(reactionType(1:n-1)))=0.0;                                       
                                     elseif n==11
                                      y(n+sum(reactionType(1:n-1)))=0.5175;
                                      y(1+n+sum(reactionType(1:n-1)))=0.5175;
                                     elseif n==12 
                                       y(n+sum(reactionType(1:n-1)))=4.0;
                                       y(1+n+sum(reactionType(1:n-1)))=4.0;                                      
                                     elseif n==13
                                      y(n+sum(reactionType(1:n-1)))=2.4422;
                                      y(1+n+sum(reactionType(1:n-1)))=2.4422;                                        
                                     end                                   
                           end   
                        else
                            if n~=7 && n~=2 && n~=1 && n~=4 && n~=9 && n~=10 && n~=12 %&& n~=8 && n~=11 && n~=13
