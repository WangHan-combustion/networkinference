...
% and a forward model
    ...
    if modelProblem==1
        ...
        for t=1:nData
             ...
             %m=[m;Rates(((t-1)*(nReactions+nSpecies)+nReactions+1):((t-1)*(nReactions+nSpecies)+nReactions+8))];
    ...
    elseif modelProblem==5
       ...
       % rate Parameters
       rateParameters=[k1f k1r k2 k3 k4 k5 k6]';
       ...
       for t=1:s
           ...
           time=input(t);
            ...
            modelPrediction=speciesConcns(2,9);
    ...
    elseif modelProblem==6
       ...
       % rate Parameters
       rateParameters=[k1f k1r k2 k3 k4 k5]';
       ...
       for t=1:s
           ...
           time=input(t);
            ...
            modelPrediction=speciesConcns(2,6);
